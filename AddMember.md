...
Agrega los siguientes paquetes de Nuget en tu proyecto **AddMember** y despuÃ©s ejecÃºtalo.
...
Verifica que puedes acceder a tu interfaz de swagger y ademÃ¡s al mÃ©todo que **weatherforecast**.

## CÃ³digo del proyecto

Crea una carpeta llamada **Data**, despuÃ©s crea un archivo **ServiceBus.cs** y agrega:
...
Agrega lo siguiente en tu **appsettings.json**, agrega tu cadena de conexiÃ³n.
...
Y por Ãºltimo puedes hacer la consulta usando tu archivo http, ya sabes, Swagger no siempre estarÃ¡ ahÃ­.
